// Note (Sofiya): Commented out because tehre were some compilation errors
//
// error[E0308]: mismatched types
//    --> src/modules/opflow.rs:175:13
//     |
// 175 |             self.focal,
//     |             ^^^^^^^^^^
//     |             |
//     |             expected `&dyn ToInputArray`, found `f64`
//     |             help: consider borrowing here: `&self.focal`
//     |
//     = note: expected reference `&dyn ToInputArray`
//                     found type `f64`

// error[E0308]: mismatched types
//    --> src/modules/opflow.rs:176:13
//     |
// 176 |             self.pp,
...
// error[E0308]: mismatched types
//    --> src/modules/opflow.rs:177:13
//     |
// 177 |             opencv::calib3d::RANSAC,
//     |             ^^^^^^^^^^^^^^^^^^^^^^^ expected `f64`, found `i32`
//     |
// help: you can convert an `i32` to an `f64`, producing the floating point representation of the integer
//     |
// 177 |             opencv::calib3d::RANSAC.into(),
//     |                                    +++++++

// error[E0308]: mismatched types
//    --> src/modules/opflow.rs:179:13
//     |
// 179 |             1.0,
...
//     modules::vis::VisPathMsg,
//     modules::messages::images_msg::ImagesMsg,
// };
