// Note (Sofiya): Some compilation errors in here, so commenting
//
// error[E0308]: mismatched types
//    --> src/modules/tracker_klt.rs:154:5
//     |
// 154 |     718.8560, // self.focal,
//     |     ^^^^^^^^
//     |     |
//     |     expected `&dyn ToInputArray`, found floating-point number
//     |     help: consider borrowing here: `&718.8560`
//     |
//     = note: expected reference `&dyn ToInputArray`
//                     found type `{float}`

// error[E0308]: mismatched types
//    --> src/modules/tracker_klt.rs:155:5
//     |
// 155 |     core::Point2d::new(607.1928, 185.2157) , //self.pp,
//     |     ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^ expected `i32`, found struct `Point_`
//     |
//     = note: expected type `i32`
//              found struct `Point_<f64>`

// error[E0308]: mismatched types
//    --> src/modules/tracker_klt.rs:156:5
//     |
// 156 |     opencv::calib3d::RANSAC,
//     |     ^^^^^^^^^^^^^^^^^^^^^^^ expected `f64`, found `i32`
//     |
// help: you can convert an `i32` to an `f64`, producing the floating point representation of the integer
//     |
// 156 |     opencv::calib3d::RANSAC.into(),
//     |                            +++++++

// error[E0308]: mismatched types
//    --> src/modules/tracker_klt.rs:158:5
//     |
// 158 |     1.0,
