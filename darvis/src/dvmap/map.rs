...
impl Map {
    ...
    pub fn create_initial_map_monocular(&mut self, inidata: &Initialization) -> Option<(DVPose, i32, i32, HashSet<Id>)> {
        ...
        let num_keypoints = inidata.initial_frame.as_ref()?.features.num_keypoints;
