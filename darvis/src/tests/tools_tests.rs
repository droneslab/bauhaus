...
mod tools_tests {
    ...
    fn test_geometric_tools() {
        ...
        let translation1 = nalgebra::Vector3::new(-0.0293614, 0.0492868, -2.58484);
        ...
        let translation2 = nalgebra::Vector3::new(-0.0113896, 0.00524169, -0.809653);
        ...
        .unwrap();
        let result_trun = (
            f64::trunc(result[0] * 10000.0) / 10000.0,
            f64::trunc(result[1] * 10000.0) / 10000.0,
